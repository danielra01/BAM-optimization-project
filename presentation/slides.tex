...
from sklearn.datasets import load_digits
    ...
    \begin{frame}
        ...
        We trained the final SGD model (up to $1000$ epochs) with $B=64$, $\eta=0.5$, and $\lambda=0$, using a stratified $70/15/15$ train/val/test split and early stopping at $\mathrm{acc}_{val}\ge 0.98$.
        \begin{columns}
            \column{0.6\paperwidth}
            \centering
            \includegraphics[width=\linewidth]{confusion-sgd.png}

            \column{0.4\paperwidth}
            \centering
            \begin{itemize}
                \item Train accuracy: $0.999$
                \item Test accuracy: $0.974$
    ...
    \end{frame}
       \begin{frame}
        ...
        We trained the final full-batch GD model (up to $1000$ iterations) with $\eta=1.0$ and $\lambda=0$, using the same stratified $70/15/15$ train/val/test split.
        \begin{columns}
            \column{0.5\paperwidth}
            \centering
            \includegraphics[width=\linewidth]{confusion-fgd.png}

            \column{0.5\paperwidth}
            \centering
            \begin{itemize}
                \item Train accuracy: $0.983$
                \item Test accuracy: $0.66$
    ...
    \begin{frame}
        ...
        \begin{columns}[T]
            \column{0.5\paperwidth}
            \centering
            \includegraphics[width=\linewidth]{valacc-vs-time-vs-lr-FGD.png}

            \column{0.5\paperwidth}
            \centering
            \includegraphics[width=\linewidth]{valacc-vs-time-vs-lr-SGD.png}
        \end{columns}
    \end{frame}
    \begin{frame}
    ...
    \begin{frame}
        ...
        \begin{columns}
            \column{0.5\paperwidth}
            \centering
            \includegraphics[width=\linewidth]{valacc-vs-batchsize.png}
        \end{columns}
    \end{frame}
    \begin{frame}
